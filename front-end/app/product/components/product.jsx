...
const Product = memo(function ({ product }) {
  ...
  return <div title={product.name} className="p-5 normal-card group flex flex-col gap-2 h-full w-full">
    <div className="grow overflow-hidden"><img className=" w-full h-full object-cover object-center group-hover:scale-110 transition-transform" src={product.avatar}></img></div>
