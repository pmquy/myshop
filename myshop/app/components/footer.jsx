    ...
    <div className="p-10 bg-white-3 flex flex-col gap-5">
      <div className="grid max-md:grid-cols-1 max-lg:grid-cols-2 grid-cols-3 md:gap-10 md:justify-between">
        ...
        <div onClick={handleClick} >
          <div className="font-semibold p-3 text-center btn">Products</div>
          <div className="max-md:max-h-0 max-md:overflow-hidden max-md:duration-1000 max-md:transition-[max-height]">
        ...
        <div onClick={handleClick}>
          <div className="font-semibold p-3 text-center btn">Professionals</div>
          <div className="max-md:max-h-0 max-md:overflow-hidden max-md:duration-1000 max-md:transition-[max-height]">
        ...
        <div onClick={handleClick}>
          <div className="font-semibold p-3 text-center btn">About LokiKurri</div>
          <div className="max-md:max-h-0 max-md:overflow-hidden max-md:duration-1000 max-md:transition-[max-height]">
        ...
        <div onClick={handleClick}>
          <div className="font-semibold p-3 text-center btn">Contact</div>
          <div className="max-md:max-h-0 max-md:overflow-hidden max-md:duration-1000 max-md:transition-[max-height]">
        ...
        <div onClick={handleClick}>
          <div className="font-semibold p-3 text-center btn">Legal</div>
          <div className="max-md:max-h-0 max-md:overflow-hidden max-md:duration-1000 max-md:transition-[max-height]">
