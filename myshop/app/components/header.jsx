...
export default function Header() {
  ...
  return <div className="flex flex-col px-5 py-2 bg-white font-medium text-xss">
    <div className=" flex justify-end items-center text-grey-1">
    ...
    <div className="flex justify-between">
      <div className=" flex gap-4">
        <Link href={'/'} className=" font-extrabold text-2xl p-2">LokiKurri.</Link>
        <div className={`flex gap-1 lg:items-end max-lg:flex-col max-lg:text-xl max-lg:gap-5 max-lg:max-h-screen max-lg:overflow-y-auto max-lg:bg-white-1 max-lg:fixed max-lg:w-screen max-lg:top-0 max-lg:left-0 ${open ? '' : 'max-lg:hidden'}`}>
          ...
          <div className="group">
            ...
            <div className={`lg:absolute lg:max-h-0 lg:opacity-0 lg:w-screen lg:group-hover:max-h-screen lg:group-hover:opacity-100 lg:transition-[max-height] lg:duration-500 lg:left-0 lg:overflow-hidden bg-white-1`}>
              <div className="flex max-lg:flex-col gap-10 p-5">
      ...
      <div className="flex items-end">
        ...
        <RiUserLine className=" w-10 h-10 p-2 hover:text-red-1" />
